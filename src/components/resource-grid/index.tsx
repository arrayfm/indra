      ...
      <div className="container grid grid-cols-10 gap-2.5 gap-y-20">
          ...
          if (resources?.layout === 'scattered') {
            ...
            return (
              <div
                key={index}
                className={cn(
                  'group col-span-10 flex min-h-100 flex-col gap-5 md:col-span-3 md:col-start-7'
                )}
              >
        ...
        {resources?.layout === 'scattered' && (
          <div className="col-span-10 flex gap-2.5">
            <div className="hidden h-fit flex-col gap-x-2.5 gap-y-60 pt-60 md:grid md:w-[calc(50%-5px)] md:grid-cols-5">
              {resources?.items?.map((resource, index) => {
            ...
            <div className="hidden h-fit flex-col gap-x-2.5 gap-y-60 pt-20 md:grid md:w-[calc(50%-5px)] md:grid-cols-5">
              {resources?.items?.map((resource, index) => {
                if (index === 0 || index % 2 === 1) return
                ...
                return (
                  <div
                    key={index}
                    className={cn('group col-span-3 flex flex-col', {
